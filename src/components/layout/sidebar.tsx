...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Campaign Attribution", href: "/recipes/analytics", icon: <Target className="h-4 w-4" /> },
      ...
      { label: "Analytics Data", href: "/recipes/campaign-attribution", icon: <TrendingUp className="h-4 w-4" /> },
